# Assignment 0: Initial Microservices Setup

## Project Overview

This assignment implements two parallel microservices for an **IoT Smart Home Sensors** domain, built with Node.js (Express) and Python (FastAPI). Both services provide identical functionality for sensor data retrieval and health monitoring.
...
- `http://localhost:8000/sensors` (FastAPI also provides `/docs` for interactive API documentation)
