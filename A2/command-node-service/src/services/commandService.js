...
class CommandService {
  ...
  async createAlert(alertData) {
    ...
    try {
      await this.sensorClient.getSensorSync(alertData.sensor_id);
    } catch (error) {
  ...
  async aggregateSensors(sensorIds) {
    ...
    const sensors = await this.sensorClient.getSensorsAsync(sensorIds);
  ...
  async createMissionPlan(missionData) {
    ...
    const allSensors = await this.sensorClient.getAllSensors();
